        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DatePush = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Blog_Account_IdAccount",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Media_Image_IdImage",
                        column: x => x.IdImage,
                        principalTable: "Image",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Media_Product_IdProduct",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Media_IdImage",
                table: "Media",
                column: "IdImage");

            migrationBuilder.CreateIndex(
                name: "IX_Media_IdProduct",
                table: "Media",
                column: "IdProduct");
